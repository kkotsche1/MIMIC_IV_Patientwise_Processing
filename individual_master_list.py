...
from hadm_extraction import hadm_extraction
...
def individual_master_list (subject_id):
  ...
  hadm_list = hadm_extraction(subject_id)

  final_dictionary = {"procedure_data":procedure_data, "prescription_data":prescription_data, "pharmacy_events":pharmacy_events, "omr_entries": omr_entries,
                      "microbiology_events":microbiology_events, "hcpcs_events": hcpcs_events, "radiology_reports": radiology_reports, "discharge_reports": discharge_reports, "hadm_list": hadm_list}
